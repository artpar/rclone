...
Build a shared library like this (change from .so to .dll on Windows):
    ...
    go build --buildmode=c-shared -o librclone.so github.com/artpar/artpar/librclone

Build a static library like this (change from .a to .lib on Windows):

    go build --buildmode=c-archive -o librclone.a github.com/artpar/artpar/librclone
...
- [RcloneInitialize](https://pkg.go.dev/github.com/artpar/artpar/librclone#RcloneInitialize)
- [RcloneFinalize](https://pkg.go.dev/github.com/artpar/artpar/librclone#RcloneFinalize)
- [RcloneRPC](https://pkg.go.dev/github.com/artpar/artpar/librclone#RcloneRPC)
- [RcloneFreeString](https://pkg.go.dev/github.com/artpar/artpar/librclone#RcloneFreeString)
...
using something like this.
    ...
    gomobile bind -v -target=android -javapkg=org.rclone github.com/artpar/artpar/librclone/gomobile
